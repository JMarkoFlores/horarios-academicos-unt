...
async function seedHorariosCicloIII() {
  ...
  const horariosCicloIIIData = [
    ...
    { docente: "Zoraida Vidal Melgarejo", curso: "Programación Orientada a Objetos II", dia: "Martes", horas: "9-1", tipo: "Laboratorio", ambiente: "Lab. 2", grupo: 2 },
    { docente: "Zoraida Vidal Melgarejo", curso: "Programación Orientada a Objetos II", dia: "Martes", horas: "2-3", tipo: "Teoría", ambiente: "I-4", grupo: 1 },
    { docente: "Zoraida Vidal Melgarejo", curso: "Programación Orientada a Objetos II", dia: "Viernes", horas: "9-1", tipo: "Laboratorio", ambiente: "Lab. 4", grupo: 3 },
    
    // 2. Everson David Agreda Gamboa - Sistémica (T:2, P:1, L:2, G:3)
    { docente: "Everson David Agreda Gamboa", curso: "Sistémica", dia: "Miércoles", horas: "9-11", tipo: "Teoría", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Everson David Agreda Gamboa", curso: "Sistémica", dia: "Miércoles", horas: "11-12", tipo: "Práctica", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Everson David Agreda Gamboa", curso: "Sistémica", dia: "Miércoles", horas: "2-4", tipo: "Laboratorio", ambiente: "Lab. 3", grupo: 1 },
    { docente: "Everson David Agreda Gamboa", curso: "Sistémica", dia: "Miércoles", horas: "4-6", tipo: "Laboratorio", ambiente: "Lab. 3", grupo: 2 },
    { docente: "Everson David Agreda Gamboa", curso: "Sistémica", dia: "Jueves", horas: "4-6", tipo: "Laboratorio", ambiente: "Lab. 3", grupo: 3 },
    
    // 3. Juan Carlos obando Roldán - Ing. Gráfica (T:1, P:1, L:2, G:2)
    { docente: "Juan Carlos obando Roldán", curso: "Ingeniería Gráfica (e )", dia: "Miércoles", horas: "7-8", tipo: "Teoría", ambiente: "posgrado A-303", grupo: 1 },
    { docente: "Juan Carlos obando Roldán", curso: "Ingeniería Gráfica (e )", dia: "Miércoles", horas: "8-9", tipo: "Práctica", ambiente: "posgrado A-303", grupo: 1 },
    ...
    { docente: "Juan Carlos obando Roldán", curso: "Ingeniería Gráfica (e )", dia: "Jueves", horas: "10-1", tipo: "Laboratorio", ambiente: "Lab. 1", grupo: 2 },
    
    // 4. Marcos Ferrer Reyna - Matemática Aplicada (T:1, P:2, L:2, G:1)
    { docente: "Marcos Ferrer Reyna", curso: "Matemática Aplicada", dia: "Jueves", horas: "2-3", tipo: "Teoría", ambiente: "Taller Confecciones - Ing. Industrial", grupo: 1 },
    { docente: "Marcos Ferrer Reyna", curso: "Matemática Aplicada", dia: "Jueves", horas: "3-4", tipo: "Práctica", ambiente: "Taller Confecciones - Ing. Industrial", grupo: 1 },
    { docente: "Marcos Ferrer Reyna", curso: "Matemática Aplicada", dia: "Miércoles", horas: "6-8", tipo: "Laboratorio", ambiente: "posgrado A-303", grupo: 1 },
    { docente: "Marcos Ferrer Reyna", curso: "Matemática Aplicada", dia: "Miércoles", horas: "8-9", tipo: "Práctica", ambiente: "posgrado A-303", grupo: 1 },
    
    // 5. Teresita Rojas Garcia - Estadística Aplicada (T:1, P:2, L:0, G:3)
    { docente: "Teresita Rojas Garcia", curso: "Estadística Aplicada", dia: "Jueves", horas: "6-7", tipo: "Teoría", ambiente: "Taller Confecciones - Ing. Industrial", grupo: 1 },
    { docente: "Teresita Rojas Garcia", curso: "Estadística Aplicada", dia: "Jueves", horas: "7-8", tipo: "Teoría", ambiente: "Taller Confecciones - Ing. Industrial", grupo: 2 },
    { docente: "Teresita Rojas Garcia", curso: "Estadística Aplicada", dia: "Jueves", horas: "8-9", tipo: "Teoría", ambiente: "Taller Confecciones - Ing. Industrial", grupo: 3 },
    { docente: "Teresita Rojas Garcia", curso: "Estadística Aplicada", dia: "Martes", horas: "4-6", tipo: "Práctica", ambiente: "posgrado A-303", grupo: 1 },
    { docente: "Teresita Rojas Garcia", curso: "Estadística Aplicada", dia: "Viernes", horas: "7-9", tipo: "Práctica", ambiente: "Taller Confecciones (Ing. Industrial)", grupo: 2 },
    { docente: "Teresita Rojas Garcia", curso: "Estadística Aplicada", dia: "Viernes", horas: "4-6", tipo: "Práctica", ambiente: "posgrado A-303", grupo: 3 },
    
    // 6. Juan Carrascal Cabanillas - Administración General (T:2, P:2, L:0, G:1)
    { docente: "Juan Carrascal Cabanillas", curso: "Administración General", dia: "Lunes", horas: "7-8", tipo: "Teoría", ambiente: "Taller Confecciones - Ing. Indust.", grupo: 1 },
    { docente: "Juan Carrascal Cabanillas", curso: "Administración General", dia: "Lunes", horas: "8-9", tipo: "Práctica", ambiente: "Taller Confecciones - Ing. Indust.", grupo: 1 },
    { docente: "Juan Carrascal Cabanillas", curso: "Administración General", dia: "Martes", horas: "7-8", tipo: "Teoría", ambiente: "I I - 2 (Pabellon Ing. Industrial)", grupo: 1 },
    { docente: "Juan Carrascal Cabanillas", curso: "Administración General", dia: "Martes", horas: "8-9", tipo: "Práctica", ambiente: "I I - 2 (Pabellon Ing. Industrial)", grupo: 1 },
    
    // 7. Vilma Mendez Gil - Física Electrónica (T:1, P:2, L:2, G:4)
    { docente: "Vilma Mendez Gil", curso: "Física Electrónica", dia: "Lunes", horas: "3-4", tipo: "Teoría", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Vilma Mendez Gil", curso: "Física Electrónica", dia: "Lunes", horas: "4-6", tipo: "Práctica", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Vilma Mendez Gil", curso: "Física Electrónica", dia: "Miércoles", horas: "2-4", tipo: "Laboratorio", ambiente: "Lab. Fisica", grupo: 1 },
    { docente: "Vilma Mendez Gil", curso: "Física Electrónica", dia: "Miércoles", horas: "4-6", tipo: "Laboratorio", ambiente: "Lab. Fisica", grupo: 2 },
    { docente: "Vilma Mendez Gil", curso: "Física Electrónica", dia: "Jueves", horas: "7-9", tipo: "Laboratorio", ambiente: "Lab. Fisica", grupo: 3 },
    { docente: "Vilma Mendez Gil", curso: "Física Electrónica", dia: "Jueves", horas: "9-11", tipo: "Laboratorio", ambiente: "Lab. Fisica", grupo: 4 },
    
    // 8. Sheyla Laura Escobedo Rodriguez - Psicología Organizacional (T:2, P:2, L:0, G:1)
    { docente: "Sheyla Laura Escobedo Rodriguez", curso: "Psicologia Organizacional (e )", dia: "Martes", horas: "6-7", tipo: "Teoría", ambiente: "posgrado A-311", grupo: 1 },
    { docente: "Sheyla Laura Escobedo Rodriguez", curso: "Psicologia Organizacional (e )", dia: "Martes", horas: "7-8", tipo: "Práctica", ambiente: "posgrado A-311", grupo: 1 },
    { docente: "Sheyla Laura Escobedo Rodriguez", curso: "Psicologia Organizacional (e )", dia: "Viernes", horas: "6-7", tipo: "Teoría", ambiente: "posgrado A-311", grupo: 1 },
    { docente: "Sheyla Laura Escobedo Rodriguez", curso: "Psicologia Organizacional (e )", dia: "Viernes", horas: "7-8", tipo: "Práctica", ambiente: "posgrado A-311", grupo: 1 },
  ];
