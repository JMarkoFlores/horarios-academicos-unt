...
async function seedHorariosCicloIII() {
  ...
  const horariosCicloIIIData = [
    ...
    { docente: "Marcos Ferrer Reyna", curso: "Matemática Aplicada", dia: "Miércoles", horas: "6-7", tipo: "Teoría", ambiente: "posgrado A-303", grupo: 1 },
    { docente: "Marcos Ferrer Reyna", curso: "Matemática Aplicada", dia: "Miércoles", horas: "7-9", tipo: "Práctica", ambiente: "posgrado A-303", grupo: 1 },
