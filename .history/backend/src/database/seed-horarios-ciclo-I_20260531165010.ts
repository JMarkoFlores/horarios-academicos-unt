...
async function seedHorariosCicloI() {
  ...
  const horariosCicloIData = [
    ...
    { docente: "Jose Luis Ponte Bejarano", curso: "Desarrollo del Pens. Logico Matemat.", dia: "Martes", horas: "10-1", tipo: "Teoría / Práctica", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Jose Luis Ponte Bejarano", curso: "Desarrollo del Pens. Logico Matemat.", dia: "Viernes", horas: "7-9", tipo: "Teoría / Práctica", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Jorge Luis Rios Gonzales", curso: "Lectura Critica y Redac. Textos Acad.", dia: "Jueves", horas: "2-6", tipo: "Teoría / Práctica", ambiente: "posgrado A-303", grupo: 1 },
    { docente: "Segundo Guibar Obeso", curso: "Introduccion al Analisis Matemático", dia: "Lunes", horas: "9-1", tipo: "Teoría / Práctica", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Segundo Guibar Obeso", curso: "Introduccion al Analisis Matemático", dia: "Martes", horas: "4-6", tipo: "Teoría / Práctica", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Miguel Ipanaque Zapata", curso: "Estadistica General", dia: "Jueves", horas: "7-9", tipo: "Práctica", ambiente: "Taller de Confecciones - Ing. Industrial", grupo: 1 },
    { docente: "Martha Cardoso", curso: "Estadistica General", dia: "Viernes", horas: "2-4", tipo: "Teoría", ambiente: "posgrado A-303", grupo: 1 },
    { docente: "Martha Cardoso", curso: "Estadistica General", dia: "Viernes", horas: "4-6", tipo: "Práctica", ambiente: "Taller de Confecciones - Ing. Industrial", grupo: 1 },
  ];
