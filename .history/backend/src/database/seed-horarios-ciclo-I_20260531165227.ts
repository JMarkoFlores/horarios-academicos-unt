...
async function seedHorariosCicloI() {
  ...
  const horariosCicloIData = [
    { docente: "Marcelino Torres Villanueva", curso: "Programación", dia: "Lunes", horas: "7-9", tipo: "Teoría", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Marcelino Torres Villanueva", curso: "Programación", dia: "Lunes", horas: "2-4", tipo: "Laboratorio (Grupo 1)", ambiente: "Lab. 3", grupo: 1 },
    { docente: "Marcelino Torres Villanueva", curso: "Programación", dia: "Lunes", horas: "4-6", tipo: "Laboratorio (Grupo 2)", ambiente: "Lab. 3", grupo: 2 },
    { docente: "Alberto Mendoza de los Santos", curso: "Ing. de Sistemas", dia: "Martes", horas: "7-10", tipo: "Teoría / Práctica", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Paul Cotrina Castellanos", curso: "Programación", dia: "Jueves", horas: "9-11", tipo: "Laboratorio (Grupo 1)", ambiente: "Lab. 4", grupo: 1 },
    { docente: "Paul Cotrina Castellanos", curso: "Programación", dia: "Jueves", horas: "11-1", tipo: "Laboratorio (Grupo 2)", ambiente: "Lab. 4", grupo: 2 },
