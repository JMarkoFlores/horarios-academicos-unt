...
async function seedHorariosCicloI() {
  ...
  await horarioRepo.createQueryBuilder("horario")
  ...
  const data = [
    ...
    // 3. Paul Cotrina Castellanos - Intro Prog (Solo Lab)
    ...
    { doc: "Bertha Urtecho Zavaleta", curso: "Desarrollo Personal", dia: 3, inicio: "07:00", fin: "09:00", tipo: TipoClase.TEORIA, amb: "TALLER-CONFECCIONES", g: "G1" },
    { doc: "Bertha Urtecho Zavaleta", curso: "Desarrollo Personal", dia: 3, inicio: "09:00", fin: "11:00", tipo: TipoClase.PRACTICA, amb: "TALLER-CONFECCIONES", g: "G1" },
    ...
    { doc: "Jose Luis Ponte Bejarano", curso: "Desarrollo del Pens", dia: 3, inicio: "11:00", fin: "13:00", tipo: TipoClase.PRACTICA, amb: "A-307", g: "G1" },
    ...
    { doc: "Segundo Guibar Obeso", curso: "Introducción al Análisis Matemático", dia: 2, inicio: "14:00", fin: "16:00", tipo: TipoClase.PRACTICA, amb: "A-307", g: "G1" },

    // 8. Miguel Ipanaque Zapata - Estadística Gral (Solo Práctica)
    ...
    { doc: "Martha Cardoso", curso: "Estadística General", dia: 5, inicio: "07:00", fin: "09:00", tipo: TipoClase.TEORIA, amb: "A-303", g: "G1" },
    { doc: "Martha Cardoso", curso: "Estadística General", dia: 5, inicio: "09:00", fin: "11:00", tipo: TipoClase.PRACTICA, amb: "TALLER-CONFECCIONES", g: "G1" },
  ];
