...
async function seedHorariosCicloVII() {
  ...
  const horariosCicloVIIData = [
    ...
    // 6. Paul Cotrina Castellanos
    { docente: "Paul Cotrina Castellanos", curso: "Metodología de la Investigación Científica", dia: "Jueves", horas: "2-6", tipo: "Teoría/Práctica", ambiente: "posgrado A-307", grupo: 1 },
