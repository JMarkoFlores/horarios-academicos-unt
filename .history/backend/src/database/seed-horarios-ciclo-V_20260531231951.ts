...
async function seedHorariosCicloV() {
  ...
  const horariosCicloVData = [
    ...
    { docente: "Luis Boy Chavil", curso: "Ingeniería de Datos I", dia: "Lunes", horas: "7-9", tipo: "Teoría", ambiente: "posgrado A-303", grupo: 1 },
    { docente: "Luis Boy Chavil", curso: "Ingeniería de Datos I", dia: "Lunes", horas: "9-10", tipo: "Práctica", ambiente: "posgrado A-303", grupo: 1 },
    { docente: "Luis Boy Chavil", curso: "Ingeniería de Datos I", dia: "Lunes", horas: "10-1", tipo: "Laboratorio", ambiente: "Lab. 4", grupo: 1 },
    { docente: "Luis Boy Chavil", curso: "Ingeniería de Datos I", dia: "Martes", horas: "7-10", tipo: "Laboratorio", ambiente: "Lab. 4", grupo: 2 },
    { docente: "Luis Boy Chavil", curso: "Ingeniería de Datos I", dia: "Martes", horas: "10-1", tipo: "Laboratorio", ambiente: "Lab. 4", grupo: 3 },
    
    // 2. Juan Carlos Obando Roldan - Sistemas de Información (T:2, P:2, L:2, G:3)
    { docente: "Juan Carlos Obando Roldan", curso: "Sistemas de Información", dia: "Miércoles", horas: "9-11", tipo: "Teoría", ambiente: "posgrado A-303", grupo: 1 },
    { docente: "Juan Carlos Obando Roldan", curso: "Sistemas de Información", dia: "Miércoles", horas: "11-1", tipo: "Práctica", ambiente: "posgrado A-303", grupo: 1 },
    ...
    { docente: "Juan Carlos Obando Roldan", curso: "Sistemas de Información", dia: "Miércoles", horas: "4-6", tipo: "Laboratorio", ambiente: "Lab 1", grupo: 2 },
    { docente: "Juan Carlos Obando Roldan", curso: "Sistemas de Información", dia: "Miércoles", horas: "6-8", tipo: "Laboratorio", ambiente: "Lab 1", grupo: 3 },
    ...
    { docente: "Everson David Agreda Gamboa", curso: "Transformación digital", dia: "Jueves", horas: "9-11", tipo: "Teoría", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Everson David Agreda Gamboa", curso: "Transformación digital", dia: "Jueves", horas: "11-1", tipo: "Laboratorio", ambiente: "Lab. 3", grupo: 2 },
    
    // 4. Robert Jerry Sánchez Ticona - Tecnología web (T:1, P:1, L:2, G:3)
    { docente: "Robert Jerry Sánchez Ticona", curso: "Tecnología web", dia: "Lunes", horas: "3-5", tipo: "Laboratorio", ambiente: "Lab1", grupo: 1 },
    { docente: "Robert Jerry Sánchez Ticona", curso: "Tecnología web", dia: "Martes", horas: "3-5", tipo: "Laboratorio", ambiente: "Lab1", grupo: 2 },
    { docente: "Robert Jerry Sánchez Ticona", curso: "Tecnología web", dia: "Miércoles", horas: "7-8", tipo: "Teoría", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Robert Jerry Sánchez Ticona", curso: "Tecnología web", dia: "Miércoles", horas: "8-9", tipo: "Práctica", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Robert Jerry Sánchez Ticona", curso: "Tecnología web", dia: "Jueves", horas: "3-5", tipo: "Laboratorio", ambiente: "Lab4", grupo: 3 },
    
    // 5. Cesar Arellano Salazar - Arquitectura de computadoras (T:1, P:2, L:2, G:3)
    { docente: "Cesar Arellano Salazar", curso: "Arquitectura de computadoras", dia: "Viernes", horas: "9-10", tipo: "Teoría", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Cesar Arellano Salazar", curso: "Arquitectura de computadoras", dia: "Viernes", horas: "10-12", tipo: "Práctica", ambiente: "posgrado A-307", grupo: 1 },
    ...
    { docente: "Cesar Arellano Salazar", curso: "Arquitectura de computadoras", dia: "Miércoles", horas: "4-6", tipo: "Laboratorio", ambiente: "Lab2", grupo: 2 },
    { docente: "Cesar Arellano Salazar", curso: "Arquitectura de computadoras", dia: "Miércoles", horas: "6-8", tipo: "Laboratorio", ambiente: "Lab2", grupo: 3 },
    ...
    { docente: "Camilo Suárez Rebaza", curso: "Teleinformática(e)", dia: "Martes", horas: "7-9", tipo: "Laboratorio", ambiente: "Lab2", grupo: 2 },
    { docente: "Camilo Suárez Rebaza", curso: "Teleinformática(e)", dia: "Viernes", horas: "5-6", tipo: "Teoría", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Camilo Suárez Rebaza", curso: "Teleinformática(e)", dia: "Viernes", horas: "6-8", tipo: "Práctica", ambiente: "posgrado A-307", grupo: 1 },
    ...
    { docente: "Marcos Baca Lopez", curso: "Investigación de Operaciones", dia: "Jueves", horas: "9-11", tipo: "Práctica", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Marcos Baca Lopez", curso: "Investigación de Operaciones", dia: "Jueves", horas: "11-12", tipo: "Teoría", ambiente: "posgrado A-307", grupo: 1 },
    
    // 8. Ana Cuadra Mitzugaray - Contabilidad Gerencial (T:1, P:2, L:2, G:1)
    { docente: "Ana Cuadra Mitzugaray", curso: "Contabilidad Gerencial", dia: "Jueves", horas: "6-7", tipo: "Teoría", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Ana Cuadra Mitzugaray", curso: "Contabilidad Gerencial", dia: "Jueves", horas: "7-8", tipo: "Práctica", ambiente: "posgrado A-307", grupo: 1 },
    { docente: "Ana Cuadra Mitzugaray", curso: "Contabilidad Gerencial", dia: "Viernes", horas: "2-4", tipo: "Laboratorio", ambiente: "posgrado A-307", grupo: 1 },
  ];
