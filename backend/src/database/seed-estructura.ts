...
export async function seedEstructura(
  queryRunner: any,
): Promise<SeedEstructuraResult> {
  ...
  const ambientesData = [
    ...
    },
    {
      ...
      piso: 1,
      pabellon: "B",
      edificio: "Edificio B - Laboratorios",
      sede: "Campus Central",
      equipamiento: "30 PCs, Proyector, Aire acondicionado, Red cableada",
      coordX: 45.0,
      coordY: 55.0,
      estado: EstadoAmbiente.ACTIVO,
    },
    ...
    },
    {
      ...
      piso: 1,
      pabellon: "C",
      edificio: "Edificio C - Ciencias Básicas",
      sede: "Campus Central",
      equipamiento: "Mesas de laboratorio, Equipos de medición, Pizarra",
      coordX: 60.0,
      coordY: 40.0,
      estado: EstadoAmbiente.ACTIVO,
    },
    {
      ...
      piso: 2,
      pabellon: "D",
      edificio: "Edificio D - Talleres",
      sede: "Campus Central",
      equipamiento: "Máquinas de coser, Mesas de corte, Planchas industriales",
      coordX: 70.5,
      coordY: 60.2,
      estado: EstadoAmbiente.ACTIVO,
    },
    {
      ...
      piso: 2,
      pabellon: "Industrial",
      edificio: "Pabellón Ingeniería Industrial",
      sede: "Campus Central",
    ...
    },
    {
      ...
      sede: "Campus Central",
      equipamiento:
        "Sistema de sonido, Proyector 4K, Pantalla motorizada, Videoconferencia",
      coordX: 42.0,
      coordY: 58.0,
      estado: EstadoAmbiente.ACTIVO,
    },
