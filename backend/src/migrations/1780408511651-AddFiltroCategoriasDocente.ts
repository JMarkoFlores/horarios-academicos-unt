...
export class AddFiltroCategoriasDocente1780408511651 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" DROP CONSTRAINT "FK_declaracion_usuario_firmante"`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" DROP CONSTRAINT "FK_declaracion_periodo"`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" DROP CONSTRAINT "FK_declaracion_facultad"`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" DROP CONSTRAINT "FK_declaracion_departamento"`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" DROP CONSTRAINT "FK_declaracion_docente"`);
        ...
        await queryRunner.query(`ALTER TYPE "public"."estado_declaracion_carga_enum" RENAME TO "estado_declaracion_carga_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."declaracion_carga_horaria_estado_enum" AS ENUM('NO_INICIADO', 'BORRADOR', 'PENDIENTE_ENVIO', 'ENVIADO_DOCENTE', 'OBSERVADO_DPTO', 'SUBSANADO', 'VALIDADO_DPTO', 'OBSERVADO_FACULTAD', 'APROBADO_FACULTAD', 'CERRADO', 'ANULADO')`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" ALTER COLUMN "estado" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" ALTER COLUMN "estado" TYPE "public"."declaracion_carga_horaria_estado_enum" USING "estado"::"text"::"public"."declaracion_carga_horaria_estado_enum"`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" ALTER COLUMN "estado" SET DEFAULT 'NO_INICIADO'`);
        await queryRunner.query(`DROP TYPE "public"."estado_declaracion_carga_enum_old"`);
        ...
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" ADD CONSTRAINT "FK_b0417bee555e733a60bfb300d4a" FOREIGN KEY ("docente_id") REFERENCES "docente"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" ADD CONSTRAINT "FK_1946165a7f4088fbc3daebc6c10" FOREIGN KEY ("departamento_id") REFERENCES "departamento"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" ADD CONSTRAINT "FK_de1e7a1dd692242f205e1cf5f0e" FOREIGN KEY ("facultad_id") REFERENCES "facultad"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" ADD CONSTRAINT "FK_57d76bc4df8fa5c871f56ca29ea" FOREIGN KEY ("periodo_academico_id") REFERENCES "periodo_academico"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "declaracion_carga_horaria" ADD CONSTRAINT "FK_1c61e9b43ca86f9243582e9ce3d" FOREIGN KEY ("usuario_firmante_id") REFERENCES "usuario"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TYPE "public"."estado_declaracion_carga_enum_old" RENAME TO "estado_declaracion_carga_enum"`);
